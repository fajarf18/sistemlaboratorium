...
<aside 
    ...
    <nav class="mt-8 flex flex-1 flex-col space-y-1">
        ...
        <a href="{{ route('admin.konfirmasi.index') }}" class="{{ request()->routeIs('admin.konfirmasi.index') ? 'bg-gray-700' : '' }} text-white group flex items-center px-2 py-2 text-sm font-medium rounded-md hover:bg-gray-700">
    <svg class="mr-3 h-6 w-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" /></svg>
    Konfirmasi
</a>
        <a href="#" class="text-gray-600 hover:bg-sky-100 flex items-center gap-3 rounded-lg px-4 py-2.5 transition-all">
